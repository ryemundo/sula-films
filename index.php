...
<link rel="stylesheet" href="assets/css/libraries.css?v=1.2" />
...
<ul class="social__icons_h" style="list-style: none;">
    ...
    <li><a href="https://www.instagram.com/sulafilmsoficial/" target="_blank"><i class="fa fa-instagram"></i></a></li>
...
<div class="bg-img"><img src="assets/images/banners/perdidos_en_la_noche.jpg" alt="slide img"></div>
...
<h2 class="slide__title" style="margin-top: 40px;">Perdidos en la Noche</h2>
<p class="slide__subtitle"></p>
<br><br>
<a href="perdidos_en_la_noche.html" class="btn btn__primary">
<span>Ver Ficha</span>
</a>
</div><!-- /.slide-content -->
</div><!-- /.col-lg-10 -->
...
============================== -->
	<div class="slide-item bg-overlay">
<div class="bg-img"><img src="assets/images/banners/cuando_los_amos_duermen.jpeg" alt="slide img"></div>
...
<h2 class="slide__title" style="margin-top: 40px;">Cuando los Amos Duermen</h2>
<p class="slide__subtitle"></p>
<br><br>
<a href="cuando_los_amos_duermen.html" class="btn btn__primary">
<span>Ver Ficha</span>
</a>
</div><!-- /.slide-content -->
</div><!-- /.col-lg-10 -->
...
============================== -->
	...
	<div class="slide-item bg-overlay">
<div class="bg-img"><img src="assets/images/banners/los_hermanos_salvador.png" alt="slide img"></div>
<div class="container">
...
<img src="assets/images/logo/Disney+ Brand Logo.svg" alt="Disney +" class="logos_plataformas">
<h2 class="slide__title" style="margin-top: 40px;">Los Hermanos Salvador</h2>
<p class="slide__subtitle"></p>
<a class="video__btn mx-3" href="https://www.disneyplus.com/series/los-hermanos-salvador/6Zp2NyW7GC8V" target="_blank">
...
<br><br>
<a href="los_hermanos_salvador.html" class="btn btn__primary">
<span>Ver Ficha</span>
</a>
</div><!-- /.slide-content -->
</div><!-- /.col-lg-10 -->
...
<div class="slide__content">
<span class="slide__subtitle">Disponible en</span>
<img src="assets/images/logo/prime_video_n.png" alt="Prime Video" class="logos_plataformas">
<h2 class="slide__title">Casi 30</h2>
    
<a class="video__btn mx-3" href="https://www.primevideo.com/region/na/detail/0L8JJUH0M85VT1LVW9NXCM0A1H/ref=atv_sr_fle_c_Tn74RA_1_1_1?sr=1-1&pageTypeIdSource=ASIN&pageTypeId=B089PYVB4Z&qid=1674593394022" target="_blank">
<div class="video__player">
<span class="video__player-animation"></span>
<span class="video__player-animation video__player-animation-2"></span>
<i class="fa fa-play"></i>
...
<div class="slide__content">
<span class="slide__subtitle">Disponible en</span>
<img src="assets/images/logo/star_plus.webp" alt="Star +" class="logos_plataformas">
<h2 class="slide__title">Prometo no enamorarme</h2>
    
<a class="video__btn mx-3" href="https://www.starplus.com/es-419/movies/prometo-no-enamorarme/IU0eiE7bCR6S" target="_blank">
<div class="video__player">
<span class="video__player-animation"></span>
<span class="video__player-animation video__player-animation-2"></span>
<i class="fa fa-play"></i>
...
<div class="swiper-slide">
    <div class="product-item">
        <div class="product__img">
            <img src="assets/images/team/Rosario-Borbolla.jpg" alt="Product">
        </div><!-- /.product-img -->
        <div class="product__content">
            <h4>Rosario Borbolla</h4>
            <span class="product__price">Asistente Administrativo</span>
        </div><!-- /.product-content -->
    </div><!-- /.product-item -->
</div>
</div>
...
<a href="http://themeforest.net/user/7oroof">sulafilms.com</a>
</p>
